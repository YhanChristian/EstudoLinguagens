...
interface ProfileDataSource {
    ...
    fun fetchSession() : String {throw UnsupportedOperationException("Not implemented")}
    fun putUser(response: Pair<User, Boolean?>?) {throw UnsupportedOperationException("Not implemented")}
